...
| S1 detection | S4 mask occlusion | S8 scan | S8 glow + sprite | S7 collected |
|---|---|---|---|---|
| ![](docs/verify/s1-detection.png) | ![](docs/verify/s4-mask-occlusion.png) | ![](docs/verify/s8-scan.png) | ![](docs/verify/s8-glow-idle.png) | ![](docs/verify/s7-collected.png) |
