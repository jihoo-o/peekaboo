...
| S1 detection | S4 mask occlusion | S8 scan | S8 glow + sprite | S11 mid-sneak (side) | S10 side placement | S7 collected |
|---|---|---|---|---|---|---|
| ![](docs/verify/s1-detection.png) | ![](docs/verify/s4-mask-occlusion.png) | ![](docs/verify/s8-scan.png) | ![](docs/verify/s8-glow-idle.png) | ![](docs/verify/s11-sneak-mid.png) | ![](docs/verify/s10-side-placement.png) | ![](docs/verify/s7-collected.png) |
